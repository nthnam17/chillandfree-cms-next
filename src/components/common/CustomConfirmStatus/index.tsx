...
const CustomConfirmStatus = ({
    ...
    cancel = 'Hủy',
    confirm = 'Đồng ý',
    title = 'Bạn có muốn cập nhật trạng thái ?', // eslint-disable-next-line @typescript-eslint/no-explicit-any
}: Props): any => {
    return (
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        <Modal
...
export default CustomConfirmStatus;
